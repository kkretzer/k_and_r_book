...
/* bfree:  add arbitrary blocks of bytes into free list */
void bfree(void *p, unsigned n)
{
    ...
    /* move p to aligned bytes, ignore the rest */
    align = (sizeof(Align) - ((long unsigned int)p % sizeof(Align))) % sizeof(Align);
    p += align, n -= align;
